...
// 	var value any
// 	var ok bool
// 	g.mkeys.Range(func(key, kv interface{}) bool {
// 		if value, ok = g.mali.Load(key); !ok {
// 			alive := value.(bool)
// 			if alive {
// 				if value, ok = g.mcancel.Load(key); ok {
// 					cancel := value.(func())
// 					cancel()
// 				} // todo: log error
// 				return false
...
// 			if alive {
// 				if cancelled {
// 					g.com <- MsgContextTerminated(key, g.ctx.Err())
// 				} else {
// 					g.com <- MsgDeadLetter(key, errors.New("shutdown"))
// 				}
// 				return false
// 			}
// 		} // todo: log error
